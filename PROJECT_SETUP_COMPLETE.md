...
🔑 Anthropic API
   Key:      sk-ant-api03-9_iGR... (in .env.local)
```
...
curl -v http://root:thinginoSh4114!@10.10.10.207/mjpeg
...
export GRAFANA_PASSWORD=grafanaSh4114!
```
...
# Test components
curl http://root:thinginoSh4114!@10.10.10.207/mjpeg
...
- [ ] Can login with sean@ecoworks.ca / grafanaSh4114!
